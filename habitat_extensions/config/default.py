...
# compatibility with the oracle used during dataset generation.
# if False, use the current version of the Habitat-Lab ShortestPathFollower
_C.TASK.VLN_ORACLE_WAYPOINT_SENSOR.USE_ORIGINAL_FOLLOWER = False
_C.TASK.VLN_ORACLE_WAYPOINT_SENSOR.DISTANCE_TO = "POINT"
# -----------------------------------------------------------------------------
...
# SPECTROGRAM_SENSOR
# -----------------------------------------------------------------------------
_C.TASK.SPECTROGRAM_SENSOR = CN()
_C.TASK.SPECTROGRAM_SENSOR.TYPE = "SpectrogramSensor"
_C.TASK.SPECTROGRAM_SENSOR.METADATA_DIR = "data/metadata"
_C.TASK.SPECTROGRAM_SENSOR.SOURCE_SOUND_DIR = "data/sounds/semantic_splits/train"
_C.TASK.SPECTROGRAM_SENSOR.RIR_SAMPLING_RATE = 16000
_C.TASK.SPECTROGRAM_SENSOR.BINAURAL_RIR_DIR = "data/binaural_rirs_lmdb"
_C.TASK.SPECTROGRAM_SENSOR.TORCH_GPU_ID = 0
_C.TASK.SPECTROGRAM_SENSOR.PANO_ROTATIONS = _C.TASK.PANO_ROTATIONS
# ----------------------------------------------------------------------------
