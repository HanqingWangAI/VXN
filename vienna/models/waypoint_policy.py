...
from vienna.models.waypoint_predictors import WaypointPredictionNet, ContrastiveNet
import traceback
...
class WaypointPolicy(Policy):
    ...
    def evaluate_actions(
        ...
        # if torch.isnan(distance_log_probs).any() or torch.isinf(distance_log_probs).any():
        #     print('distance log prob', distance_log_probs)

        # if torch.isnan(pano_log_probs).any() or torch.isinf(pano_log_probs).any():
        #     print('pano log prob', pano_log_probs)

        # if torch.isnan(offset_log_probs).any() or torch.isinf(offset_log_probs).any():
        #     print('offset log prob', offset_log_probs)
        #     print('offset is ', action_components["offset"])
